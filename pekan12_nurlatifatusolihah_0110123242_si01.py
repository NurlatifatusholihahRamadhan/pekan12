...
badak = Badak("badak", "Rumput", "Daratan", "Melahirkan", "20 tahun", "Jantan")
ikan = Ikan("Ikan", "Makanan Ikan", "Air", "Bertelur", "20 Ekor", "Koi")
ular = Ular("Ular", "Ayam", "Alam Bebas", "Bertelur", "4 Meter", "Iya")
